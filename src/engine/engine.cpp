...
void Nighthawk::NighthawkEngine::createCommandBuffer()
{
...
void Nighthawk::NighthawkEngine::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
...
void Nighthawk::NighthawkEngine::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo)
{
  createInfo = {};
